...
# Files
########################################################################
SRC  += aic/aic.c button/button.c hwinit/hwinit.c i2c/i2c.c input/input.c lcd/spi.c lcd/display.c
SRC	 += led/led.c output/output.c sound/sound.c timer/timer.c timer/pit.c morse/morse.c navigation/navigation.c
SRC  += Cstartup_SAM7.c $(TARGET).c
ASRC  = Cstartup.S 
COBJ  = $(SRC:.c=.o) 
AOBJ  = $(ASRC:.S=.o)
